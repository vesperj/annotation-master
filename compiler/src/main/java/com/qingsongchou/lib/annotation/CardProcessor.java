package com.qingsongchou.lib.annotation;
...
public class CardProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        try {
            ...
            if (type != null) {
                JavaFile.builder("com.qingsongchou.social", type).build().writeTo(mFiler);
            }
...
//            routerInitBuilder.addStatement("router.put($S, $T.class)", s.substring(0, s.lastIndexOf(".")), ClassName.get((TypeElement) element));
        ...
        TypeElement routerInitializerType = elementUtils.getTypeElement("com.qingsongchou.social.annotation.ICardMapInitializer");
